...
function Navigation() {
  return (
    <div className="nav-bg text-white" style={{minHeight:"100vh"}}>
      <div className="title">Expense Tracking</div>
      ...
      <div style={{marginLeft:"17px",marginRight:"17px",position:"absolute",bottom:"0"}}>
        ...
        <div className="d-flex mt-2 mb-2" style={{paddingLeft:"30px",paddingRight:"30px"}}>
            ...
            <div style={{textAlign:"center",paddingTop:"5%",width:"110px"}}>UserName</div>
        </div>
      </div>
    </div>
  );
